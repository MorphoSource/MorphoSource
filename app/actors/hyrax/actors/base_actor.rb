...
# This is copied from Hyrax 5.0.5 to only use Valkyrie to save Valkyrized works
# todovalk This can be removed when all works are Valkyrized
module Hyrax
  module Actors
    ##
    ...
    class BaseActor < AbstractActor
      ...
      def create(env)
        ...
        use_valkyrie = Hyrax.config.use_valkyrie? && Wings::ModelRegistry.reverse_lookup(env.curation_concern.class)

        save(env, use_valkyrie: use_valkyrie) &&
