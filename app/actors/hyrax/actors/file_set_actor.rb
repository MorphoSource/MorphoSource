    ...
    class FileSetActor # rubocop:disable Metrics/ClassLength
      ...
      def attach_to_work(work, file_set_params = {})
        acquire_lock_for(work.id) do
          ...
          Rails.logger.debug "[in FileSetActor] work's representative_id #{work.representative_id}, thumbnail_id #{work.thumbnail_id},  ordered_members #{work.ordered_members&.to_a.map(&:id)}"
          work.save
