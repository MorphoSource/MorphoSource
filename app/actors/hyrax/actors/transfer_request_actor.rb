    ...
    class TransferRequestActor < AbstractActor
      ...
      private
        ...
        def create_proxy_deposit_request(env)
          # if owner (organization) has been set on the submission form, skip
          return true if env.curation_concern.owner.present?

          proxy = env.curation_concern.on_behalf_of
          return true if proxy.blank?

          ContentDepositorChangeEventJob.perform_now(env.curation_concern,
