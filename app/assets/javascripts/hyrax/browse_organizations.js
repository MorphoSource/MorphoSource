$(document).ready(function() {
    ...
    if ($('body.organizations.browse').length) { // check if the page is browse organizations
      ...
      $('.choose-columns-organizations .toggle-vis').on( 'click', function (e) {
        //e.preventDefault();
        var column = organizationsTable.column( $(this).attr('data-column') );
