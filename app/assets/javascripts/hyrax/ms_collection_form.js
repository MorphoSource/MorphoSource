...
$(document).ready(function() {
  ...
  if ( $('form[id*="edit_collection"]').length || $('form[id*="edit_media_list"]').length || $('form[id*="edit_sequential_section_list"]').length ) { // if collection form page (edit)
    ...
    } else if ($('form[id*="edit_media_list"]').length) {
      form = $('form[id*="edit_media_list"]')[0];
    } else if ($('form[id*="edit_sequential_section_list"]').length) {
      form = $('form[id*="edit_sequential_section_list"]')[0];
    }
