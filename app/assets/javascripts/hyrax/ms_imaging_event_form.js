var showFieldsByModality = function() {
  ...
  case 'MicroNanoXRayComputedTomography':
    ...
    $('.ie_photogrammetry, .ie_photography, .ie_sequential_section_scan').children('input, select').val('');
    break;
  case 'Photogrammetry':
    $('.ie_photogrammetry').addClass('show').removeClass('hide');
    $('.ie_xray_ct, .ie_sequential_section_scan').children('input, select').val('');
    break;
  case 'Photography':
    ...
    break;
  case 'SequentialSectionScan':
    $('.ie_sequential_section_scan').addClass('show').removeClass('hide');
    $('.ie_photogrammetry, .ie_photography, .ie_xray_ct').children('input, select').val('');
    break;
  default: // any other modality
    $('.ie_xray_ct, .ie_photogrammetry, .ie_photography, .ie_sequential_section_scan').children('input, select').val('');
  }
}
