...
var showFieldsByModality = function() {
  ...
  $('.ie_xray_ct, .ie_photogrammetry, .ie_photography, .ie_slide_scan').addClass('hide').removeClass('show');
  ...
  case 'MicroNanoXRayComputedTomography':
    ...
    $('.ie_photogrammetry, .ie_photography, .ie_slide_scan').children('input, select').val('');
    break;
  case 'Photogrammetry':
    $('.ie_photogrammetry').addClass('show').removeClass('hide');
    $('.ie_xray_ct, .ie_slide_scan').children('input, select').val('');
    break;
  case 'Photography':
    ...
    break;
  case 'SlideScan':
    $('.ie_slide_scan').addClass('show').removeClass('hide');
    $('.ie_photogrammetry, .ie_photography, .ie_xray_ct').children('input, select').val('');
    break;
  default: // any other modality
    $('.ie_xray_ct, .ie_photogrammetry, .ie_photography, .ie_slide_scan').children('input, select').val('');
  }
}
