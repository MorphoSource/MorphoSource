  ...
  class FindOrganizations < Qa::Authorities::FindWorks
    ...
    def search(_q, controller)
      ...
      docs.map do |doc|
        ...
        country = doc.country
        { id: id, label: title, value: id, organization_type: organization_type, institution_code: institution_code, institution_name: institution_name, collection_code: collection_code, description: description, address: address, city: city, state_province: state_province, country: country }
      end
    end
