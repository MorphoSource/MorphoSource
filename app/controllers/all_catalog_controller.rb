...
class AllCatalogController < CatalogController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field solr_name("modality", :symbol), label: "Media Modality", limit: 6, helper_method: :modality_label_by_id
    ...
    config.add_facet_field solr_name("keyword", :symbol), label: "Media Tag", limit: 5
    config.add_facet_field solr_name("taxonomy", :symbol), label: "Media Taxonomy", limit: 5
    config.add_facet_field solr_name('member_of_collections', :symbol), label: 'Media Team / Project', limit: 5
    # objects
    config.add_facet_field solr_name("creator", :symbol), label: "Object Creator", limit: 5
    # organization
