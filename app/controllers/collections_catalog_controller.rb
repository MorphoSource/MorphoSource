...
class CollectionsCatalogController < CatalogController
  ...
  configure_blacklight do |config|
    ...
    # facet fields
    config.add_facet_field "type", field: "human_readable_type_sim", label: "Project or Team", limit: 10
    config.add_facet_field "organization", field: "linked_organization_ssim", label: "Organization", limit: 10
