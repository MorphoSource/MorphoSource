...
class MediaCatalogController < CatalogController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field "modality", field: "modality_ssim", label: "Modality", limit: DEFAULT_LIMIT, helper_method: :modality_label_by_id
    config.add_facet_field "object_type", field: "media_physical_object_type_ssim", label: "Object Type", limit: DEFAULT_LIMIT
    config.add_facet_field "organization", field: "media_organization_ssim",label: "Organization", limit: DEFAULT_LIMIT
    ...
    config.add_facet_field "team", field: "member_of_teams_ssim", label: 'Team', limit: DEFAULT_LIMIT
    config.add_facet_field "project", field: "member_of_projects_ssim", label: 'Project', limit: DEFAULT_LIMIT
    config.add_facet_field "media_list", field: "member_of_media_lists_ssim", label: 'Media List', limit: DEFAULT_LIMIT
    config.add_facet_field "seq_section_list", field: "member_of_sequential_section_lists_ssim", label: 'Seq. Section List', limit: DEFAULT_LIMIT
    config.add_facet_field "owner", field: "user_with_ownership_name_ssim", label: 'Data Manager', limit: DEFAULT_LIMIT
    config.add_facet_field "depositor", field: "depositor_name_ssim", label: 'Data Uploader', limit: DEFAULT_LIMIT
