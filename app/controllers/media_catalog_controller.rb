...
class MediaCatalogController < CatalogController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field "device", field: "media_device_id_ssim", label: "Imaging Device", limit: DEFAULT_LIMIT, helper_method: :device_title_by_id
    ...
    config.add_facet_field "owner", field: "user_with_ownership_ssi", label: 'Data Manager', limit: 2, helper_method: :user_name_by_id
    config.add_facet_field "depositor", field: "depositor_ssim", label: 'Data Uploader', limit: 2, helper_method: :user_name_by_id
