...
class MediaCatalogController < CatalogController
  ...
  configure_blacklight do |config|
    ...
    # facet fields
    config.add_facet_field "type", field: "human_readable_media_type_ssim", label: "Type", limit: 10
    ...
    config.add_facet_field "publication", field: "publication_status_ssi", label: "Publication", limit: 10
    ...
    config.add_facet_field "data_manager", field: "user_with_ownership_name_ssim", label: 'Data Manager', limit: 10
    config.add_facet_field "data_uploader", field: "depositor_name_ssim", label: 'Data Uploader', limit: 10
