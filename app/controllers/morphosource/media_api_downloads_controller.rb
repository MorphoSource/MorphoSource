 ...
 to do:
  ...
  - revert the media_downloads_controller.rb

  - Possibly this new controller could inherit from MediaDownloadsController but overwrite specific methods as necessary.
    Or alternately both the new controller and MediaDownloadsController could pull from a common behavior module
