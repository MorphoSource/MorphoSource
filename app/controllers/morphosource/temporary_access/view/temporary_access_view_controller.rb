# Handles viewing of records through temporary access link
# Must be customized by inheriting controller classes
module Morphosource
  module TemporaryAccess
    module View
      class TemporaryAccessViewController < MediaController
