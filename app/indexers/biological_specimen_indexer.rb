...
class BiologicalSpecimenIndexer < Morphosource::PhysicalObjectIndexer
  ...
  def generate_solr_document
    super.tap do |solr_doc|
      ...
      gbif_taxonomies = object.gbif_taxonomies
      gbif_taxonomy_terms = gbif_taxonomies.map { |t| t.gbif_taxonomy_array }.flatten
      gbif_taxonomy_id = gbif_taxonomies.map { |t| t.id.to_s }
      ...
      solr_doc['gbif_taxonomy_id_tesim'] = gbif_taxonomy_id
      solr_doc['gbif_taxonomy_id_ssim'] = gbif_taxonomy_id
