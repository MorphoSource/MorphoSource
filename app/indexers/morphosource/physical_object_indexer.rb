  ...
  class PhysicalObjectIndexer < Morphosource::WorkIndexer
    ...
    def generate_solr_document
      super.tap do |solr_doc|
        ...
        media_team_ids = solr_values(media, "member_of_team_ids_ssim")
        media_project_ids = solr_values(media, "member_of_project_ids_ssim")
        # public media values
        public_human_readable_media_types = solr_values(public_media, "human_readable_media_type_ssim")
        media_member_of_public_collection_ids = solr_values(public_media, "member_of_public_collection_ids_ssim")
        ...
        solr_doc['media_member_of_project_ids_ssim'] = media_project_ids
        solr_doc['media_member_of_team_ids_ssim'] = media_team_ids
        # media tags
