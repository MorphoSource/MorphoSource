...
# Overrides Hyrax's ControlledVocabularyInput to call .first on rdf_label before
# setting data-label. Without this, the array serializes as '["value"]' in the
# Select2 field. Track against hyrax/app/inputs/controlled_vocabulary_input.rb
# when upgrading Hyrax — only build_options_for_existing_row differs from upstream.
