...
module Hyrax
  ...
  class FileMetadata < Valkyrie::Resource
    ...
    # Include MorphoSource-specific mime-type methods
    include Morphosource::Works::MimeTypes

    # Include additional attributes
    include Hyrax::Schema(:file_metadata_extended)
    include Hyrax::Schema(:file_metadata_image_extended)
    include Hyrax::Schema(:file_metadata_dicom)
    include Hyrax::Schema(:file_metadata_mesh)
    include Hyrax::Schema(:file_metadata_zip_contents)
