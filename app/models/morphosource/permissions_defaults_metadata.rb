module Morphosource
  module PermissionsDefaultsMetadata
    ...
    included do
      # Download Permission set on Organization
      # Determines default publication settings
      # media visibility, fileset_visibility, fileset_accessibility

      # Download Reviewer
      property :download_reviewer, predicate: ::RDF::URI.new("https://www.morphosource.org/terms/downloadReviewer") do |index|
      ...
      # Additional Usage Agreement
      property :usage_agreement, predicate: ::RDF::URI.new("https://www.morphosource.org/terms/usageAgreement") do |index|
        index.as :stored_searchable
      end
