# Copy Hyrax 2.9.6 changes to update polymorphic_path to use symbols instead of strings for compatibility with the Rails 5.2.8 update.
# https://github.com/samvera/hyrax/commit/e2ab6e7c458bcfa7a09f6df3978f6da1fd39ebcc
