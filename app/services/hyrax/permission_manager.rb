...
# copied from samvera/hyrax @ v5.0.5 and modified to add download permissions
...
module Hyrax
  ...
  class PermissionManager
    ...
    def download_groups=(groups)
      update_groups_for(mode: DOWNLOAD, groups: groups)
      download_groups
    end
    ...
    def download_users=(users)
      update_users_for(mode: DOWNLOAD, users: users)
      download_users
    end
