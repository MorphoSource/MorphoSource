# Copied over exactly from Hyrax 5.0.5 except that WorkflowActionInfo is replaced with Hyrax::WorkflowActionInfo to correct module referencing
# todo5: Fine for now, but when updating Hyrax should check to see if this file needs updating
