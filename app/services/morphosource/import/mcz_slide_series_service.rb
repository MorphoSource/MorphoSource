module Morphosource
  module Import
    class MczSlideSeriesService < SlideSeriesService
      ...
      class_attribute :characterization_class
      self.characterization_class = ImportSlides::Characterization::MczCharacterization
      ...
      def slides
        @json["extensions"]["http://rs.tdwg.org/ac/terms/Multimedia"]
        # select only thumbnails or best quality
      end
      ...
      private
        ...
        # def get_item_values
        #   item_uri = @media.import_url
        #   item_json = JSON.parse((RestClient.get item_uri).body)
        #
        #   @characterization.file_id = item_json["largeImage"]["fileId"]
        #   @characterization.slide_name = item_json["name"]
        # end
        #
        # def get_file_values
        #   file_uri = "https://images.slide-atlas.org/api/v1/file/#{@characterization.file_id}"
        #   file_json = JSON.parse((RestClient.get file_uri).body)
        #
        #   @characterization.mime_type = file_json["mimeType"]
        #   @characterization.file_name = file_json["name"]
        #   @characterization.size = file_json["size"]
        #   @characterization.date_created = file_json["created"]
        # end
        #
        # def get_tile_values
        #   tiles_uri = @media.import_url + "/tiles"
        #   tiles_json = JSON.parse((RestClient.get tiles_uri).body)
        #
        #   @characterization.levels = tiles_json["levels"]
        #   @characterization.magnification = tiles_json["magnification"]
        #   @characterization.x_spacing = tiles_json["mm_x"]
        #   @characterization.y_spacing = tiles_json["mm_y"]
        #   @characterization.width = tiles_json["sizeX"]
        #   @characterization.height = tiles_json["sizeY"]
        # end
        #
