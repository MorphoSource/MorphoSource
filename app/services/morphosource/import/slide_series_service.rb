      ...
      private
        ...
        def import_gbif_slides
          ...
          media.each do |m|
            ...
            @thumbnail_path = m["http://rs.tdwg.org/ac/terms/accessURI"] #"https://images.slide-atlas.org/api/v1/item/5c454d3c70aaa9064404a300/tiles/thumbnail?width=160&height=100"
