Rails.application.configure do
  ...
  config.cache_store = ENV['MEMCACHE_SERVERS'] ? [:mem_cache_store, ENV['MEMCACHE_SERVERS']] : :mem_cache_store

  # Use a real queuing backend for Active Job (and separate queues per environment)
  config.active_job.queue_adapter = :resque
  # config.active_job.queue_name_prefix = "MorphoSource_SF_#{Rails.env}"
