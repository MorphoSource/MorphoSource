...
Hydra.configure do |config|
  ...
  config.permissions.download.group           = ActiveFedora.index_field_mapper.solr_name("download_access_group", :symbol)
  config.permissions.download.individual      = ActiveFedora.index_field_mapper.solr_name("download_access_person", :symbol)
  #
