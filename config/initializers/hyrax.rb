Hyrax.config do |config|
  ...
  # mount point.
  #
  config.whitelisted_ingest_dirs = ENV.fetch('WHITELISTED_INGEST_DIRS', '').split(':').presence || ['/nas/morphosource_globus/', '/vagrant/downloads/', '/opt/morphosource/root/tmp/', '/vagrant/dropbox']
