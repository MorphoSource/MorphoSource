Rails.application.routes.draw do
  ...
  #     # resources :sequential_section_lists, except: [:index]

  #     # sequential_section_lists
  #     get 'sequential_section_lists/:id', to: 'sequential_section_lists#show', as: 'dashboard_sequential_section_list_media'
  #     get 'sequential_section_lists/:id/biological_specimens', to: 'sequential_section_lists/biological_specimens#show', as: 'dashboard_sequential_section_list_specimens'
  #     get 'sequential_section_lists/:id/cultural_heritage_objects', to: 'sequential_section_lists/cultural_heritage_objects#show', as: 'dashboard_sequential_section_list_chos'
  #     get 'sequential_section_lists/:id/about', to: 'sequential_section_lists#edit', as: 'dashboard_sequential_section_list_about'
  #     get 'sequential_section_lists/:id/members', to: 'sequential_section_lists#members', as: 'dashboard_sequential_section_list_members'
  #     get 'sequential_section_lists/:collection_id/facet/:id', to: 'sequential_section_lists#facet', as: 'dashboard_sequential_section_list_media_facet'
  #     get 'sequential_section_lists/:collection_id/biological_specimens/facet/:id', to: 'sequential_section_lists/biological_specimens#facet', as: 'dashboard_sequential_section_list_specimens_facet'
  #     get 'sequential_section_lists/:collection_id/cultural_heritage_objects/facet/:id', to: 'media_lists/cultural_heritage_objects#facet', as: 'dashboard_sequential_section_list_chos_facet'
  #   end
  # end
