Rails.application.routes.draw do
  ...
  scope module: :morphosource do
    ...
    post '/download/from-api/:id', to: 'media_downloads#download_from_api', as: 'download_from_api'
  end
  ...
  # Generate media download link
  post 'api/download/:id', to: 'morphosource/media_downloads#api_generate_download', as: 'api_media_generate_download', defaults: { format: 'json' }
