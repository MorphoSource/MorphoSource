...
export default class MorphosourceEditor extends Editor {
  ...
  controlledVocabularies() {
    this.element.find('.controlled_vocabulary.form-group').each((_idx, controlled_field) => {
      let gettyFields = ".cultural_heritage_object_aat_type, .cultural_heritage_object_aat_material, .cultural_heritage_object_aat_attribute, .cultural_heritage_object_tgn, .cultural_heritage_object_periodic_time"
