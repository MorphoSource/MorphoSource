...
const MorphosourceControlledVocabulary = require('morphosource/ms_controlled_vocabulary');
    ...
    class PhysicalObjectSearchCreateView extends SubmissionView {
      ...
      eventFuncs() {
        ...
        $('#submission_will_create_cho').click(function(event){
          ...
          // var MorphosourceControlledVocabulary = import('ms_controlled_vocabulary');


          // import MorphosourceControlledVocabulary from 'ms_controlled_vocabulary'

          // const MorphosourceControlledVocabulary = require('ms_controlled_vocabulary');

          function controlledVocabularies() {
            // console.log("self.form.listClass: " + self.form.listClass())
            $('#new_cultural_heritage_object .controlled_vocabulary.form-group').each((_idx, controlled_field) =>
            // console.log("controlled_field: " + controlled_field);
            // console.log("this: " + this)
              new MorphosourceControlledVocabulary(controlled_field, 'cultural_heritage_object')
            )
          }
