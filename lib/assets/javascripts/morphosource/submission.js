    ...
    class RawOrDerivedView extends SubmissionView {
      ...
      eventFuncs() {
        ...
        $("select[name='submission[on_behalf_of]']").change(function() {
          ...
          // add on_behalf_of as data manager option to select and select it

          var media_owner = $('#media_owner');
          console.log('creating select')
          media_owner.siblings('span').remove();
          media_owner.parent().append(`<span>${$("select[name='submission[on_behalf_of]'] option:selected").text()}</span>`);
          media_owner.children().remove();
          media_owner.append(`<option value="${$(this).val()}" readonly="readonly" style="display:none;">${$("select[name='submission[on_behalf_of]'] option:selected").text()}</option>`);
          media_owner.css("display","none");


          // $('#media_owner').children(":first").val($(this).val());
          // $('#media_owner').children(":first").text($("select[name='submission[on_behalf_of]'] option:selected").text());
          // $('#media_owner').children(":first").css("display","none");
          // $('#media_owner').children(":first").prop( "disabled", true );
        });
