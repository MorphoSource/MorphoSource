class SubmissionForm {
    ...
    $.get('/submissions/organization_default_media_fields',
     ...
     function(getData){
      ...
      if (getData.default_fields) {
        ...
        self.configureReviewerMode(getData.default_fields, getData.organization_permissions_mode === 'Require');
        self.resetDataOwner();
  ...
  configureReviewerMode(defaultFields, mandateValues, selectedMode = null) {
    ...
    mode.onchange = function() {
      updatePicker();
      if (eligible && !mandateValues) $.alert($('#organization-alert-message').text());
    };
    updatePicker();
    if (picker) {
