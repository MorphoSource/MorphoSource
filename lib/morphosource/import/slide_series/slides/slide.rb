    ...
    module SlideSeries
      module Slides
        class Slide
          ...
          MEDIA_ARRAY_METHODS = %w[description fileset_accessibility identifier license magnification publisher related_url rights_holder short_description slice_thickness title unit x_spacing y_spacing z_spacing]
