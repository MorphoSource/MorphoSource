...
# override resque-kubernetes gem and use this to force k8s api requests to use namespace scope only
# todo5 remove and use internal fork of gem instead, or submit PR to original repo
...
module Resque
  module Kubernetes
    ...
    class JobsManager
      ...
      def finished_pods
        resque_jobs = pods_client.get_pods(
          label_selector: "resque-kubernetes=pod",
          namespace: @default_namespace
        )
