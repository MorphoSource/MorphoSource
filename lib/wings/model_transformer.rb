...
module Wings
  ...
  class ModelTransformer
    ...
    def attributes
      ...
      append_valkyrie_member_ids(result)
    ...
    def append_valkyrie_member_ids(attrs)
      return unless pcdm_object.try(:valkyrie_member_ids)
      attrs[:member_ids] ||= []
      attrs[:member_ids].concat(pcdm_object.valkyrie_member_ids.to_a)
    end
  end
end
