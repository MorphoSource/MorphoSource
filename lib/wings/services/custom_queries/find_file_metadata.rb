...
# NOTE: This file overrides Hyrax's Wings FindFileMetadata behavior to return nil instead
# of raising Hyrax::ObjectNotFoundError when AF-backed FileMetadata is missing during
# Valkyrie transition. This avoids failing derivative/indexing jobs for legacy FileSets.
# TODO: Remove this override once FileSets and FileMetadata are fully migrated to Valkyrie.
module Wings
  module CustomQueries
    ...
    class FindFileMetadata
      ...
      def find_file_metadata_by_alternate_identifier(alternate_identifier:, use_valkyrie: true)
        ...
        return nil if object.new_record? || object.empty?
