      ...
      context "when the processing event's params include parents" do
        ...
        context 'and the parent imaging event is not changed' do
          ...
          before do
            ...
            allow(subject).to receive(:new_parent_ancestors).and_return([])
          end
        ...
        context 'and the parent media is not changed' do
          ...
          before do
            ...
            allow(subject).to receive(:new_parent_ancestors).and_return([imaging_event])
          end
        ...
        context 'and the parents are changed' do
          ...
          before do
            ...
            allow(subject).to receive(:new_parent_ancestors).and_return([])
            allow(subject).to receive(:new_parents).and_return([new_imaging_event])
          end
          ...
          context 'and the imaging event is updated' do
            ...
            before do
              ...
              works = [imaging_event, processing_event, media]
              works.each(&:save)
              subject.instance_variable_set(:@original_parents, [imaging_event])
            end
        ...
        context 'and the media is updated' do
          ...
          before do
            ...
            allow(subject).to receive(:new_parent_ancestors).and_return([new_imaging_event])
            subject.instance_variable_set(:@original_parents, [media])
          end
          context 'and the new organization does not have a linked team' do
