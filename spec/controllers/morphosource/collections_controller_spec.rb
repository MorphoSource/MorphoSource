...
RSpec.describe Morphosource::CollectionsController, type: :controller do
  ...
  #       before do
  #         allow(subject).to receive(:params).and_return({:id => media_list.id})
  #       end
  #       it 'redirects to the media lists controller' do
  #         get :show, params: { id: media_list.id }
  #         expect(response).to redirect_to(media_list_media_path(request.parameters))
  #       end
  #     end
  #     context 'collection is a sequential section list' do
  #       before do
  #         allow(subject).to receive(:params).and_return({:id => sequential_section_list.id})
  #       end
  #       it 'redirects to the sequential section lists controller' do
  #         get :show, params: { id: sequential_section_list.id }
  #         expect(response).to redirect_to(sequential_section_list_media_path(request.parameters))
  #       end
  #     end
  #   end
  # end
