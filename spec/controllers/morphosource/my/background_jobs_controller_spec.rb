...
RSpec.describe Morphosource::My::BackgroundJobsController, type: :controller do
  describe "GET #index" do
    ...
    context 'returns background job data for the user' do
      render_views
      ...
      let!(:job2) { BackgroundJob.create({ job_id: 'ewiuryewiruewr', status: 'working', user_id: batch_submission_contributor.user_key, created_objects: {} }) }
      let!(:job3) { BackgroundJob.create({ job_id: 'mcbxzvkbvmcnxb', status: 'working', user_id: contributor.user_key, created_objects: {} }) }
