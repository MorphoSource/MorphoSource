  ...
  describe 'create_work_if_needed' do
    ...
    context 'organization is an organization work' do
      ...
      context 'organization has a team' do
        ...
        context 'the team does not have a data manager' do
          let(:organization)  { FactoryBot.create(:organization, team_id: [team.id]) }
          context 'visibility is restricted' do
            let(:visibility)  { 'restricted' }
            context 'depositor chooses transfer immediately' do
              let(:transfer_management) { 'immediate' }
        ...
        context 'the organization has a data manager' do
          let(:organization)  { FactoryBot.create(:organization, team_id: [team.id], data_manager: [data_manager.ms_id]) }
          context 'visibility is restricted' do
            let(:visibility)  { 'restricted' }
            context 'depositor chooses transfer immediately' do
              let(:transfer_management) { 'immediate' }
