...
PROJECT_DOC_ATTRIBUTES = {
  ...
  collection_type_gid_ssim: [Hyrax::CollectionType.find_or_create_by(Morphosource::CollectionTypes::Projects::SETTINGS).to_global_id.uri],
  human_readable_type_tesim: ["Project"],
