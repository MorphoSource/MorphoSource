...
RSpec.feature "Accessibility check", :accessibility => true, :type => :feature, :driver => :firefox_headless do
    ...
    expect(page).to have_content 'Log in'
		...
		click_button("Log in")
    expect(page).to have_content 'a11ytest@duke.edu' # make sure user is logged in
