...
RSpec.describe Hyrax::MediaForm do
  ...
  let(:single_valued_fields)  { [:short_description, :media_type, :cite_as, :legacy_media_file_id, :legacy_media_group_id, :uuid, :ark, :doi, :available, :x_spacing, :y_spacing, :z_spacing, :slice_thickness, :series_type, :unit, :identifier, :related_url, :terms_of_use, :download_reviewer, :agreement_uri, :permits_3d_use, :permits_commercial_use] }
