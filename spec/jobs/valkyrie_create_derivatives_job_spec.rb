...
RSpec.describe ValkyrieCreateDerivativesJob do
  ...
  describe '#perform' do
    ...
    describe 'archive (ZIP mesh) derivative creation' do
      ...
      let(:parent_work) { double('parent_work', id: 'parent-work-id', media_type: ['Mesh'], unit: ['mm'], is_remote_backed?: false, has_remote_manifest?: false, remote_manifest_url: nil) }
    ...
    describe 'parent reindex when file_set is the parent thumbnail' do
      ...
      let(:file_metadata) { get_file_metadata(file_set) }
      let(:parent_work) { double('parent_work', id: 'parent-work-id', thumbnail_id: file_set.id, is_remote_backed?: false, has_remote_manifest?: false) }
