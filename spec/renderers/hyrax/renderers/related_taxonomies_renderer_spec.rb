...
RSpec.describe Hyrax::Renderers::RelatedTaxonomiesRenderer do
  ...
  let(:taxonomy)          { build(:taxonomy_resource, id: "def456", title: ["Domain > Kingdom > Phylum"], depositor: "msid333")}
  let(:canonical_taxonomy){ build(:taxonomy_resource, id: "ghi789", title: ["Superclass > Class > Subclass"], depositor: "msid333") }
  let(:trusted_taxonomy)  { build(:taxonomy_resource, id: "jkl123", title: ["Superorder > Order > Suborder"], depositor: "msid333")}
  let(:user_taxonomy)     { build(:taxonomy_resource, id: "mno456", title: ["Superfamily > Family > Subfamily"], depositor: "msid333") }
