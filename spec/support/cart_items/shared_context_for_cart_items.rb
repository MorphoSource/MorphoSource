RSpec.shared_context 'cart items', :shared_context => :metadata do
  ...
  let(:cartItem1)     { CartItem.create( user_id: current_user.ms_id, work_id: work1.id, in_cart: true, date_requested: Time.current.yesterday, date_downloaded: Time.current.yesterday, date_approved: Time.current.yesterday, date_expired: Time.current.tomorrow, reviewers: [depositor.ms_id]) }
  let(:cartItem2)     { CartItem.create( user_id: current_user.ms_id, work_id: work2.id, in_cart: true, date_downloaded: Time.current.yesterday, reviewers: [depositor.ms_id]) }
  ...
  let(:cartItem4)     { CartItem.create( user_id: current_user.ms_id, work_id: work4.id, in_cart: false, date_downloaded: Time.current.yesterday, reviewers: [depositor.ms_id]) }
  let(:cartItem5)     { CartItem.create( user_id: current_user.ms_id, work_id: work5.id, in_cart: false, date_downloaded: nil, date_requested: Time.current.yesterday, reviewers: [depositor.ms_id]) }
