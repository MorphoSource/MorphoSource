RSpec.shared_context 'cart items', :shared_context => :metadata do
  ...
  let(:work6)         { Media.create(id: "fff", title: ["Test Work Title"], depositor: depositor.ms_id, visibility: 'open', fileset_accessibility: ['open'], record_download_reviewer_users: [reviewer.ms_id], morphosource_use_agreement_type: morphosource_use_agreement_type, required_archival_of_published_derivatives: required_archival_of_published_derivatives, permits_3d_use: permits_3d_use, permits_commercial_use: permits_commercial_use) }
